...
Our study applied a Geographically Weighted Regression (GWR) model to explore the connection between walkability and diabetes prevalence across the U.S. Simulations with artificial data validated the model's effectiveness, showing accurate, reliable predictions with evenly dispersed residuals.

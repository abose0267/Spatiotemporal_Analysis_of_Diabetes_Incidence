...
## Generates Artificial Dataset, Fits a GWR and plots the residuals of the response variable
source("data/artificialData.R")
source("analysis/gwrAnalysis.R")
# Generate data
...
```{r}
## Calculates the Mean Squared Error of the Predicted Coefficients vs the True Coefficients

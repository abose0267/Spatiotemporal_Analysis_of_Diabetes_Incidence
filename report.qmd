...
library(spgwr)
gwr.montecarlo(DIABETES_CrudePrev ~ NatWalkInd + OBESITY_CrudePrev + BPHIGH_CrudePrev + LPA_CrudePrev + CSMOKING_CrudePrev + Median.Household.Income + avg_temp, sf_spatial_data, nsims=99, kernel="exponential",adaptive=F, gwr_model_results$GW.arguments$bw) 
```
```{r , results='hide',message=FALSE,echo={FALSE}}
library(GWmodel)
library(sp)

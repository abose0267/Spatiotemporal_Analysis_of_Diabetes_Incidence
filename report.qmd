...
table <- knitr::kable(gwr_result_sim$GW.diagnostic$gwR2.adj)
```
...
plot2 <- plots %>%
  ...
  scale_fill_gradient2(low = "blue", mid = "white", high = "red", midpoint = 0, name = "Impact") +
  labs(title = "Estimated Impact of Walkability Index Score") +
  theme(legend.position = "bottom")
...
![](impact_plot.png "Figure 1: Impact of Walkability on Diabetes Prevalence"){fig-align="center"}
